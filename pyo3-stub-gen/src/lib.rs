...
/// **DEPRECATED**: Use [`type_alias!`] instead.
///
/// This macro is deprecated and will be removed in a future version.
/// The [`type_alias!`] macro now provides the same functionality with a simpler syntax.
///
/// # Migration
///
/// Replace:
/// ```rust,ignore
/// define_type_alias! {
///     pub struct MyAlias in "module"; TypeA | TypeB
/// }
/// ```
///
/// With:
/// ```rust,ignore
/// type_alias!("module", MyAlias = TypeA | TypeB);
/// ```
///
/// Both macros now generate a struct that can be registered at runtime using
