...
- `examples/` - Example projects showing different maturin layouts (pure, mixed_sub, etc.)
...
# Work with specific example (replace 'pure' with mixed_sub, etc.)
task pure:stub-gen
task pure:test
```
...
```bash
cd examples/pure  # or mixed_sub, etc.
